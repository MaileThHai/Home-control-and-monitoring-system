...
String BOTtoken = "7022828785:AAEZX-InbaobVxV0ZDjz-BYnhhmIKEhrKFU";  // your Bot Token (Get from Botfather)
String CHAT_ID = "6999992513";      
  ...
  if (clientTCP.connect(myDomain, 443)) {
    ...
    while ((startTimer + waitTime) > millis()){
      ...
      while (clientTCP.available()) {
        ...
        if (c == '\n') {
          if (getBody.length()==0) state=true; 
          getBody = "";
        } 
        else if (c != '\r')
          getBody += String(c);
