  ...
  while (1) {
    ...
    if (e32ttl100.available() > 1) {
      ...
      if (typeStr == "CTW") {
        ...
        Serial.println(*(uint8_t *)(controlweb.ctlw1));
        ctrolweb1 = *(uint8_t *)(controlweb.ctlw1);
        Serial.println(*(uint8_t *)(controlweb.ctlw2));
        ctrolweb2 = *(uint8_t *)(controlweb.ctlw2);
        Serial.println(*(uint8_t *)(controlweb.ctlw3));
        ctrolweb3 = *(uint8_t *)(controlweb.ctlw3);
        // Close the response struct container
        rsc.close();
        checkctlw = 1;
      } else {
